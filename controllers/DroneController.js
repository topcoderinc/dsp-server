...
function* updateLocation(req, res) {
  ...
  const droneFields = helper.convertQueryFieldStringToArray(req.query.droneFields);
  ...
  const drone = yield DroneService.updateLocation(req.params.id, req.body, returnNFZ,
    nfzFields, nfzLimit, nearDronesMaxDist, nearDroneFields, nearDronesLimit,droneFields);
  res.json(drone);
